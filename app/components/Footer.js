        ...
        <div className="footer-top">
          <div className="footer-brand-block">
            ...
            <div className="footer-socials">
              <a href="https://www.instagram.com/mayas.india/" aria-label="Instagram" className="footer-social-icon" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://www.facebook.com/profile.php?id=61576739254460" aria-label="Facebook" className="footer-social-icon" target="_blank" rel="noopener noreferrer">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                </svg>
              </a>
              <a href="https://wa.me/918918793380" aria-label="WhatsApp" className="footer-social-icon" target="_blank" rel="noopener noreferrer">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
